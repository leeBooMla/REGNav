...
from src.renet import StyleEncoder, RelationNetwork,copy_state_dict
import clip
    ...
    def __init__(
        ...
        if backbone == "clip":
            ...
            if not self.is_blind:
                ...
                self.feature_encoder = StyleEncoder()
                copy_state_dict(room_expert_ckpt_path_dir+'style_encoder.pkl', self.feature_encoder, strip='module.')
                self.relation_network = RelationNetwork()
                copy_state_dict(room_expert_ckpt_path_dir+'relation_network.pkl', self.relation_network, strip='module.')
