...
class PPOTrainer(BaseRLTrainer):
    ...
    def _resume_config(self, resume_state=None):
        ...
        if resume_state is not None:
            ...
            print("Current config does not match with resume state!\n{}".format(unmatch_config))
            ...
            resume_state["config"]: Config = self.config
    ...
    def _init_train(self, resume_state=None):
        ...
        # self.agent.actor_critic.policy_components[0].visual_encoder.encoder[1].room_encoder.encoder = load_model(self.agent.actor_critic.policy_components[0].visual_encoder.encoder[1].room_encoder.encoder, "/data/lpn/room-expert/checkpoints/mp3d/30shot-5way/test222/max_acc.pth")
